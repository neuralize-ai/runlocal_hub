...
class BenchmarkTableSchema(BaseModel):
    """
    ...
    ComputeUnits: Optional[str] = None
    InferenceMsMedian: Optional[Decimal] = None
    InferenceMsStdDev: Optional[Decimal] = None
    LoadMsMedian: Optional[Decimal] = None
    ...
    # ProfileData: Optional[List[ProfileRow]] = None

    ## OUTPUT VALIDATION
    # GTOutputValidationScoresPerOutput: Optional[Dict[str, PerTensorScore]] = None

...
class ModelNotFoundError(RunLocalError):
    ...
    - Model was deleted
    """
    def __init__(self, message: str, model_id: Optional[str] = None, available_models: Optional[List[str]] = None):
        super().__init__(message)
...
class DeviceNotAvailableError(RunLocalError):
    ...
    """
    def __init__(self, message: str, filters_used: Optional[Dict] = None, available_count: int = 0):
        super().__init__(message)
...
class JobTimeoutError(RunLocalError):
    ...
    """
    def __init__(self, message: str, timeout: int = 0, completed_jobs: int = 0, total_jobs: int = 0):
        super().__init__(message)
...
class TensorError(RunLocalError):
    ...
    """
    def __init__(self, message: str, tensor_id: Optional[str] = None, operation: Optional[str] = None):
        super().__init__(message)
...
class ValidationError(RunLocalError):
    ...
    """
    def __init__(self, message: str, parameter: Optional[str] = None, expected: Optional[str] = None, got: Optional[str] = None):
        super().__init__(message)
...
class NetworkError(RunLocalError):
    ...
    """
    def __init__(self, message: str, endpoint: Optional[str] = None, retry_count: int = 0):
        super().__init__(message)
        self.endpoint = endpoint
...
class ConfigurationError(RunLocalError):
    ...
    """
    def __init__(self, message: str, config_key: Optional[str] = None, suggestion: Optional[str] = None):
        super().__init__(message)
